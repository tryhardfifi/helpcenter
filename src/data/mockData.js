  ...
  company: {
    ...
    analytics: {
      ...
      topSources: [
        ...
        { url: "producthunt.com/posts/acme-inc", mentionRate: 18.6, percentage: 16.4, trend: "stable", type: "publication" },
        { url: "acme.com/case-studies/enterprise", mentionRate: 15.2, percentage: 13.4, trend: "up", type: "own" },
        { url: "techcrunch.com/acme-raises-series-b", mentionRate: 12.9, percentage: 11.3, trend: "down", type: "publication" },
        { url: "news.ycombinator.com/item?id=acme-launch", mentionRate: 10.5, percentage: 9.2, trend: "up", type: "publication" },
        ...
        { url: "medium.com/@saas-reviewer/acme-deep-dive", mentionRate: 5.2, percentage: 4.6, trend: "stable", type: "publication" },
      ],
    },
  },
